            ...
            <div class="card-body">
                <div class="row mb-6">
                    ...
                    <div class="col-lg-6 col-sm-6">
                        ...
                        <div class="mb-3"><label for="formFile" class="form-label">Selectionnner le PDF</label>
                             <input class="form-control" type="file" name="pdf_file"  id="formFile">
                            @error('pdf_file')
                                <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        <div class="mb-3"><label for="formFile" class="form-label">Selectionnner date limite de publication</label> <input
                            class="form-control" type="date" name="dateLimite" >
                            @error('dateLimite')
                                <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
