            ...
            <ul class="nav flex-column pt-3 pt-md-0">
                <li class="nav-item"><a href="https://demo.themesberg.com/volt-pro/index.html"
                        class="nav-link d-flex align-items-center"><span class="sidebar-icon"><img
                                ...
                                width="20" alt="Volt Logo"> </span><span class="mt-1 sidebar-text">Admin-Babillard</span></a></li>
                                    ...
                                    <a href="calendar.html"
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-auto"> <img alt="Image placeholder"
                                                    src="https://demo.themesberg.com/volt-pro/assets/img/team/profile-picture-1.jpg"
        ...
        <div class="table-settings mb-4">
            <div class="row align-items-center justify-content-between">
                <div class="col col-md-6 col-lg-3 col-xl-4">
                    <div class="input-group me-2 me-lg-3 fmxw-400"><span class="input-group-text"><svg
